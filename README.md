...
## Acknowledgements
Big thanks to [Jeltron](https://github.com/Jeltr0n) for their overlay work, the [Onion OS](https://github.com/OnionUI/Onion) and [Spruce](https://github.com/spruceUI/spruceOS) devs, Russ at [Retro Game Corps](https://retrogamecorps.com/), [wansti](https://github.com/wansti) for the upscales, and everyone who contribute to the community at the Retro Game Handhelds discord and the many retro gaming subreddits. **Enjoy!*
